...
bool FitCircle2d(PCRef pc, pcl::PointIndices& inliers, pcl::ModelCoefficients& coefficients, float distanceThreshold = 0.01, bool optimize = true)
{
	pcl::SACSegmentation<Point> seg;
	seg.setOptimizeCoefficients(optimize);
...
bool FitPlane(PCRef pc, pcl::PointIndices& inliers, pcl::ModelCoefficients& coefficients, float distanceThreshold = 0.01, bool optimize = true)
{
	pcl::SACSegmentation<Point> seg;
	seg.setOptimizeCoefficients(optimize);
